...
const INPUT_DIR = path.join(process.cwd(), "models", "fsl_alphabet", "bilstm_v2");
const OUTPUT_DIR = path.join(process.cwd(), "models", "fsl_alphabet", "bilstm_v2_tfjs");
...
const main = async () => {
  console.log("Exporting BiLSTM v2 model to TensorFlow.js format");
  ...
  const modelJson = {
    ...
    generatedBy: "fsl-alphabet-bilstm-v2-export",
  ...
  console.log("BiLSTM v2 TFJS export complete.");
};
