...
const INPUT_DIR = path.join(process.cwd(), "models", "fsl_alphabet", "bilstm");
const OUTPUT_DIR = path.join(process.cwd(), "models", "fsl_alphabet", "bilstm_tfjs");
...
const main = async () => {
  console.log("Exporting BiLSTM model to TensorFlow.js format");
  ...
  const modelJson = {
    ...
    generatedBy: "fsl-alphabet-bilstm-export",
  ...
  console.log("BiLSTM TFJS export complete.");
};
