...
const INPUT_DIR = path.join(process.cwd(), "models", "fsl_105", "bilstm");
const OUTPUT_DIR = path.join(process.cwd(), "models", "fsl_105", "bilstm_tfjs");
...
const main = async () => {
  console.log("Exporting FSL-105 BiLSTM model to TensorFlow.js format");
  ...
  console.log(`Labels: ${OUTPUT_CLASSES}`);
  ...
  const modelJson = {
    ...
    generatedBy: "fsl-105-bilstm-export",
  ...
  console.log("FSL-105 BiLSTM TFJS export complete.");
};
