...
const TAGALOG_MARKERS = new Set([
  ...
  "maganda", "pakiusap", "kumusta", "mabuti", "sige", "ba", "na", "pa",
...
const ENGLISH_MARKERS = new Set([
  ...
  "whom", "this", "that", "these", "those", "am", "are", "is", "was",
  "were", "been", "being", "have", "has", "had", "having", "do", "does",
  "did", "doing", "will", "would", "shall", "should", "may", "might",
  "must", "can", "could",
]);

export function detectLanguage(words: string[]): LanguageDetectionResult {
