...
export const BUILT_IN_DICTIONARY: DictionaryEntry[] = [
  ...
  // The "ka"/"ka na" forms are listed explicitly, not inferred. Matching is
  // longest-first, so without them "kumusta ka" matched only "kumusta" and left
  // "ka" to resolve on its own as a second gloss (YOU) -- the phrase came out
  // as two signs and spelled twice. A form that is not in the dictionary cannot
  // be matched as a phrase no matter how the matcher is written.
  { label: "HOW ARE YOU", gloss: "HOW ARE YOU", synonyms: ["how are you", "kumusta", "kamusta", "kumusta ka", "kamusta ka", "kumusta ka na", "kamusta ka na", "kumusta na", "kamusta na"], english: ["how are you", "how are you doing"], filipino: ["kumusta", "kamusta", "kumusta ka", "kamusta ka", "kumusta ka na", "kamusta ka na", "kumusta na", "kamusta na"], category: "greeting", animationAsset: "HOW ARE YOU", suggestedReplies: ["IM FINE", "FINE", "GOOD"] },
